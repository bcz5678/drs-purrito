...
var COPY_CA_LABEL = "Copy CA";
var CONTRACT_ADDRESS = "9nQ19kEKYcmtSHZA9hEgxXBkEAGAotgXQFJFBFgUpump";
//#endregion
//#region src/components/SiteHeader.tsx
var logo = { url: "/site/images/catpoltle_logo_clear.png" };
function XLogo() {
...
function TelegramLogo() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
		...
		className: "h-6 w-6",
		fill: "currentColor",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm5.01 7.36c.18-.01.38.06.44.28.06.22-.06.72-.13 1.07-.22 1.2-.9 4.65-1.27 6.23-.16.67-.47.9-.77.93-.65.06-1.14-.43-1.77-.84-.99-.65-1.55-1.05-2.51-1.69-.6-.39-.21-.61.13-.96.09-.09 1.63-1.49 3.29-3.03.13-.12.23-.28.06-.36-.09-.04-.24 0-.36.08-1.9 1.21-3.62 2.3-4.4 2.86-.4.29-.79.43-1.15.18-.43-.3-1.36-.6-2.05-.86-.72-.27-.63-.62.08-.94 2.36-1.06 5.05-2.24 6.66-2.9.75-.31 1.7-.7 2.42-.86.14-.03.25-.05.34-.05z" })
	});
}
function SiteHeader({ title, code }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: "sticky top-0 z-30 border-b border-border bg-card shadow-sm",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-7 bg-strip" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex h-[68px] items-center px-4 md:px-7",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: logo.url,
								alt: "Catpotle Mexican Grill",
								className: "h-full w-full object-contain"
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "hidden h-7 w-px bg-border sm:block" }),
					...
					className: "ml-auto flex min-w-0 items-center gap-3 md:gap-7",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: code }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { className: "h-3.5 w-3.5 shrink-0" })]
							})] })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
							href: SOCIAL.x,
							"aria-label": "X",
							className: "p-2 text-brand transition-opacity hover:opacity-60",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XLogo, {})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
							href: SOCIAL.telegram,
							"aria-label": "Telegram",
							className: "p-2 text-brand transition-opacity hover:opacity-60",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TelegramLogo, {})
						})
					]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "mt-0.5 h-3.5 w-3.5 shrink-0" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "break-all",
							children: code
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { className: "mt-0.5 h-3.5 w-3.5 shrink-0" })
					]
				})]
			})
		]
...
//#endregion
//#region src/lib/orderStorage.ts
var KEY_PREFIX = "purrito-order:";
function saveOrder(order) {
	try {
		localStorage.setItem(KEY_PREFIX + order.pickup_number, JSON.stringify(order));
	} catch {}
}
function loadOrder(pickupNumber) {
	try {
...
var layerImg = (file) => `/site/images/build/${file}`;
layerImg("tortilla.png");
var PROTEINS = [
	{
		id: "maine-coon-asado",
		name: "Maine Coon Asado",
		img: img("01_Maine_Coon.png"),
		detail: "180 cal",
		price: 10.95
	},
	{
	...
	},
	{
		...
		img: img("04_American_Shorthair.png"),
		detail: "170 cal",
		price: 10.45
	},
	{
		id: "bengal-barbacoa",
		name: "Bengal Barbacoa",
		img: img("05_Bengal.png"),
		detail: "210 cal",
		price: 11.45
	},
	{
		id: "catnitas",
		name: "Catnitas",
		img: img("03_British_Shorthair.png"),
		detail: "210 cal",
		price: 11.25
	},
	{
...
var RICE = [{
	id: "white-rice",
	name: "White Rice",
	img: img("white-rice.png"),
	layer: layerImg("white_rice.png"),
	detail: "Cilantro-Lime",
	detail2: "210 cal",
	price: 0
}, {
	id: "brown-rice",
	name: "Brown Rice",
	img: img("brown-rice.png"),
	layer: layerImg("white_rice.png"),
	detail: "Cilantro-Lime",
	detail2: "210 cal",
	price: 0
...
var TOPPINGS = [
	{
		id: "cilantro-lime-sauce",
		name: "Cilantro Lime Sauce",
		img: img("cilantro-lime-sauce.png"),
		layer: layerImg("white_rice.png"),
		detail: "Made Fresh Daily",
		detail2: "80 cal",
		price: 0
	},
	{
	...
	},
	{
		...
		img: img("fresh-tomato-salsa.png"),
		layer: layerImg("tomato_salsa.png"),
		detail: "Mild",
		detail2: "25 cal",
		price: 0
	},
	{
		...
		img: img("roasted-chili-corn-salsa.png"),
		layer: layerImg("corn_salsa.png"),
		detail: "Medium",
		detail2: "80 cal",
		price: 0
	},
	{
		...
		img: img("tomatillo-green-chili-salsa.png"),
		layer: layerImg("tomatillo_green_salsa.png"),
		detail: "Medium",
		detail2: "15 cal",
		price: 0
	},
	{
		...
		img: img("tomatillo-red-chili-salsa.png"),
		layer: layerImg("salsa_verde.png"),
		detail: "Hot",
		detail2: "30 cal",
		price: 0
	},
	{
		id: "sour-cream",
		name: "Sour Cream",
		img: img("sour-cream.png"),
		layer: layerImg("sour_cream.png"),
		detail2: "110 cal",
		price: 0
	},
	{
		id: "fajita-veggies",
		name: "Fajita Veggies",
		img: img("fajita-veggies.png"),
		layer: layerImg("fajita_vegetables.png"),
		detail2: "20 cal",
		price: 0
	},
	{
	...
	},
	{
		...
		img: img("romaine-lettuce.png"),
		layer: layerImg("lettuce.png"),
		detail2: "5 cal",
		price: 0
	},
	{
		id: "queso-blanco",
		name: "Queso Blanco",
		img: img("queso-blanco.png"),
		layer: layerImg("black_beans.png"),
		detail: "$1.60",
		detail2: "120 cal",
		price: 1.6
	}
...
//#endregion
export { TOPPINGS as a, loadOrder as c, CONTRACT_ADDRESS as d, Button as f, SIDES as i, saveOrder as l, PROTEINS as n, findItem as o, createLucideIcon as p, RICE as r, money as s, DRINKS as t, SiteHeader as u };
