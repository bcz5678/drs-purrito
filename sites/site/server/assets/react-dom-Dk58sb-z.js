...
//#endregion
export { deepEqual as A, replaceEqualDeep as B, processRouteTree as C, arraysEqual as D, DEFAULT_PROTOCOL_ALLOWLIST as E, isDangerousProtocol as F, usePrevious as G, useForwardedRef as H, isModuleNotFoundError as I, __require as J, require_react as K, isPromise as L, escapeHtml as M, functionalUpdate as N, createControlledPromise as O, hasKeys as P, last as R, processRouteMasks as S, invariant as T, useIntersectionObserver as U, reactUse as V, useLayoutEffect as W, __toESM as Y, trimPathRight as _, ClientOnly as a, findRouteMatch as b, cleanPath as c, interpolatePath as d, joinPaths as f, trimPathLeft as g, trimPath as h, routerContext as i, encodePathLikeUrl as j, decodePath as k, compileDecodeCharMap as l, resolvePath as m, useStore as n, useHydrated as o, removeTrailingSlash as p, __commonJSMin as q, useRouter as r, require_jsx_runtime as s, require_react_dom as t, exactPathTest as u, buildRouteBranch as v, createLRUCache as w, findSingleMatch as x, findFlatMatch as y, nullReplaceEqualDeep as z };
